...
public class Uploadflatsactivity extends AppCompatActivity {
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(contact)) {
                    ...
                    final StorageReference reference = firebaseStorage.getReference().child("flats")
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            reference.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                ...
                                public void onSuccess(Uri uri) {
                                    ...
                                    database.getReference().child("flats").push().setValue(model)
                                            .addOnSuccessListener(new OnSuccessListener<Void>() {
                                                @Override
                                                public void onSuccess(Void unused) {

                                                    Toast.makeText(Uploadflatsactivity.this, "Room Upload Successfully", Toast.LENGTH_SHORT).show();
                                                    dialog.dismiss();
                                                }
                                                ...
                                                public void onFailure(@NonNull Exception e) {
                                                    dialog.dismiss();
                                                    Toast.makeText(Uploadflatsactivity.this, "Error Occurred", Toast.LENGTH_SHORT).show();
                                                }
                                            });
                                }
                            });
        ...
        Dexter.withContext(this).withPermission(Manifest.permission.READ_EXTERNAL_STORAGE)
                .withListener(new PermissionListener() {
                    ...
                    public void onPermissionDenied(PermissionDeniedResponse permissionDeniedResponse) {
                        ...
                        Toast.makeText(Uploadflatsactivity.this, "Permission Denied", Toast.LENGTH_SHORT).show();
