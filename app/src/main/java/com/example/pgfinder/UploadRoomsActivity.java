...
public class UploadRoomsActivity extends AppCompatActivity {
                                ...
                                database.getReference().child("product").push().setValue(model)
                                        .addOnSuccessListener(new OnSuccessListener<Void>() {
                                            ...
                                            public void onSuccess(Void unused) {
                                                ...
                                                Toast.makeText(UploadRoomsActivity.this, "Room Upload Successfully", Toast.LENGTH_SHORT).show();
                                                dialog.dismiss();
                                            }
                                            ...
                                            public void onFailure(@NonNull Exception e) {
                                                dialog.dismiss();
                                                Toast.makeText(UploadRoomsActivity.this, "Error Occurred", Toast.LENGTH_SHORT).show();
                                            }
                                        });
                            }
                        });
        ...
        Dexter.withContext(this).withPermission(Manifest.permission.READ_EXTERNAL_STORAGE)
                .withListener(new PermissionListener() {
                    ...
                    public void onPermissionDenied(PermissionDeniedResponse permissionDeniedResponse) {
                        ...
                        Toast.makeText(UploadRoomsActivity.this, "Permission Denied", Toast.LENGTH_SHORT).show();
